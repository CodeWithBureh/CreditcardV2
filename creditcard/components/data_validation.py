...
from creditcard.constant.training_pipeline import SCHEMA_FILE_PATH
from scipy.stats import ks_2samp
import pandas as pd
import os,sys
from creditcard.utils.main_utils.utils import read_yaml_file,write_yaml_file
...
class DataValidation:
    ...
    def initaite_data_validation(self)->DataValidationArtifact:
        try:
            ...
            return CreditCardException("e",sys)
