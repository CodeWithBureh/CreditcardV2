...
import os
from creditcard.constant import training_pipeline
...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.train_file_path:str=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_DIR_NAME,
                                              training_pipeline.TRAIN_FILE_NAME.replace("csv","npy"),)
        self.test_file_path:str=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_DIR_NAME,
